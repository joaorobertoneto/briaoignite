            ...
            <div class="bloco">
                <div class="row">
                            ...
                            <div class="card">
                                <table>
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="fw-bold fs-6">Preço</td>
                                        </tr>
                                        <tr>
                                            <td class="cinza">quantidade</td>
                                        </tr>
                    ...
                    <tr>
                        ...
                        <td><?= $produto['preco'] ?></td>
                        <td>
                            <td> <button class="btn btn-sm roxo txt-sm"> <a class="edit" href="/editar/<?= $produto['id'] ?>">Editar</a></button> </td>
                            <form action="/delete/<?= $produto['id'] ?>" method="post">
                              <td> <button class="btn btn-sm roxo txt-sm" type="submit">Excluir</button></td>
                            </form>
                        </td>
                    </tr>
                <?php endforeach; ?>
