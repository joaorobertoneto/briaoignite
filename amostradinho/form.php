        ...
        <div class="wrapper">
            <div class="header d-flex align-items-center justify-content-between px-5">
                ...
                <div class="busca ms-auto">
                   <form class="d-flex flex-nowrap" action="/search" method="post">
                        <input type="text" class="form-control form-cinza">
                        <button class="btn roxo pesquisa type" type="submit">
                    ...
                    <div class="row mt-1">
                        <div class="card-submit">
                            ...
                            <form action="receba" method="post">
                                ...
                                <div class="form-group">
    <div class="col-md-4 mb-3">
                                    <label class="fw-bold" for="KmInputLabel">Laboratorio:</label>
                                    <input type="text" class="form-control" id="KmInputLabel" name="laboratorio">
                                  </div>
                                </div>
                                <div class="form-group">
                                  <div class="col-md-4 mb-3">
                                    <label class="fw-bold" for="KmInputLabel">Preço:</label>
                                    <input type="text" class="form-control" id="KmInputLabel" name="preco">
                                  </div>
                                </div>
                                <div class="form-group">
                                  <div class="col-md-4 mb-3">
                                   <label class="fw-bold" for="AnoInputLabel">quantidade:</label>
                                   <input type="text" class="form-control" id="AnoInputLabel" name="quantidade">
                                  </div>
                                </div>
                                <button type="submit" class="btn roxo py-2" name="submit">Adicionar produtos</button>
                              </form>
